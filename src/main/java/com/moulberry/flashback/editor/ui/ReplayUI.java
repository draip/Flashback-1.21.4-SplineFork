...
import com.moulberry.flashback.timings.SplineWindow;
import com.moulberry.flashback.timings.WindowOpenStateSpline;
import imgui.*;
import imgui.flag.*;
...
public class ReplayUI {
    ...
    public static void drawOverlayInternal() {
        ...
        if (WindowOpenStateSpline.SPLINE.get()) {
            SplineWindow.render(WindowOpenStateSpline.SPLINE, WindowOpenStateSpline.splineNewlyOpened);
            WindowOpenStateSpline.splineNewlyOpened = false;
        }
